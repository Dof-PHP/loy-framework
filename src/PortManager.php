...
final class PortManager
{
    ...
    public static function add(
        ...
        $models  = $attrs['MODEL']   ?? null;
        $models  = $models === '_'   ? null : $defaultModels;
        $mimein  = $attrs['MIMEIN']  ?? null;
        $mimein  = $mimein === '_'   ? null : $defaultMimein;
        $mimeout = $attrs['MIMEOUT'] ?? null;
        $mimeout = $mimeout === '_'  ? null : $defaultMimeout;
        $suffix  = $attrs['SUFFIX']  ?? $defaultSuffix;
        $wrapin  = $attrs['WRAPIN']  ?? null;
        $wrapin  = $wrapin === '_'   ? null : $defaultWrapin;
        $wrapout = $attrs['WRAPOUT'] ?? null;
        $wrapout = $wrapout === '_'  ? null : $defaultWrapout;
