...
class Response
{
    ...
    /** @var array: The extra context used to logging */
    private $logging = [];
    ...
    public function redirect(
        ...
        if ($params) {
            ...
            $params = $urlencode ? urlencode($params) : urldecode($params);
            $url .= $params;
        }

        $this->status = $status;
        $this->sent = true;
        $this->logging('url', $url);
    ...
    public function logging(string $key, $val = null)
    {
