...
GWT('Test underline2camelcase #1', 'a_b_c', function ($given) {
    return underline2camelcase($given);
}, function ($result) {
    return $result === 'ABC';
});

GWT('Test underline2camelcase #2', '__a_b___c__', function ($given) {
    return underline2camelcase($given);
}, function ($result) {
    return $result === 'ABC';
});

GWT('Test underline2camelcase #3', '__a_b___C__', function ($given) {
    return underline2camelcase($given);
}, function ($result) {
    return $result === 'ABC';
});

GWT('Test camelcase2underline #1', 'abCDEf', function ($given) {
    return camelcase2underline($given);
}, function ($result) {
    return $result === 'ab_c_d_ef';
});

GWT('Test camelcase2underline #2', 'AbCDEf__', function ($given) {
    return camelcase2underline($given);
}, function ($result) {
    return $result === 'ab_c_d_ef__';
});

GWT('Test camelcase2underline #3', 'ABCDEf__', function ($given) {
    return camelcase2underline($given);
}, function ($result) {
    return $result === 'a_b_c_d_ef__';
});
